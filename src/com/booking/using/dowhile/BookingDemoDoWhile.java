package com.booking.using.dowhile;
import com.booking.using.dowhile.model.Customer;
import com.booking.using.dowhile.model.DeliveryAgent;
import com.booking.using.dowhile.model.Order;
import com.booking.using.dowhile.model.Restaurant;

import java.util.Scanner;
public class BookingDemoDoWhile {

    static Scanner sc = new Scanner(System.in);

    public static void main(String[] args) {
        BookingDemoDoWhile bd = new BookingDemoDoWhile();
        int option = 0;
        do {
